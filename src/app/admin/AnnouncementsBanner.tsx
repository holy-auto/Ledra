          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                {!ann.is_read && <span className="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-accent" />}
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm font-medium text-primary leading-tight">{ann.title}</div>
                  {isExpanded && (
                    <div className="mt-2 text-xs text-secondary whitespace-pre-wrap leading-relaxed">{ann.body}</div>
                  )}
                </div>
                <svg
                  width="16"
