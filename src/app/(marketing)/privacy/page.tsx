  ...
  return (
    <Article>
      ...
      <Ul>
        ...
        <li>
          施工写真に含まれる位置情報（GPS）
          ※撮影場所の整合性確認のためにアップロード処理中に照合のみ行い、座標そのものは保存しません（保存する画像からも位置情報は除去します）
        </li>
        <li>
          出張作業の作業場所の位置情報（スタッフが作業開始／完了時に取得したもの）
          ※スタッフの運用目的に限定して最小権限で管理し、一定期間経過後に自動削除します
        </li>
      ...
      <Ul>
        ...
        <li>施工写真・作業記録の真正性確認（撮影場所の整合性チェック）</li>
