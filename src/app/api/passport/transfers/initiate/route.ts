...
import { apiOk, apiValidationError, apiForbidden, apiNotFound, apiInternalError } from "@/lib/api/response";
...
export const POST = withCaller(
  ...
  { rateLimit: "sensitive", routeName: "passport/transfers/initiate" },
);
