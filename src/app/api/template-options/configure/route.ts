...
import { apiOk, apiValidationError, apiInternalError, apiNotFound, apiForbidden } from "@/lib/api/response";
...
export const GET = withCaller(
  ...
  { routeName: "template-options/configure GET" },
);
...
export const POST = withCaller(
  ...
  { permission: "template_options:manage", routeName: "template-options/configure POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "template_options:manage", routeName: "template-options/configure PUT" },
);
