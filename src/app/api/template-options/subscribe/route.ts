...
import { apiOk, apiValidationError, apiInternalError, apiError } from "@/lib/api/response";
...
export const POST = withCaller(
  ...
  { rateLimit: "auth", permission: "template_options:manage", routeName: "template-options/subscribe" },
);
