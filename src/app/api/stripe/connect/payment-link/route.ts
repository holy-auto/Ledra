...
import { apiOk, apiInternalError, apiNotFound, apiValidationError, apiForbidden } from "@/lib/api/response";
...
export const POST = withCaller(
  ...
  { rateLimit: "auth", permission: "payments:create", routeName: "stripe connect payment-link: session" },
);
