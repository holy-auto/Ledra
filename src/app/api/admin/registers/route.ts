...
export const GET = withCaller(
  ...
  { permission: "registers:view", routeName: "admin/registers GET" },
);
...
export const POST = withCaller(
  ...
  { permission: "registers:manage", routeName: "admin/registers POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "registers:manage", routeName: "admin/registers PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "registers:manage", routeName: "admin/registers DELETE" },
);
