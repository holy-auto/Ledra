...
export const GET = withCaller(
  ...
  { routeName: "admin/contact-schedules GET" },
);
...
export const POST = withCaller(
  ...
  { minRole: "staff", routeName: "admin/contact-schedules POST" },
);
...
export const PATCH = withCaller(
  ...
  { minRole: "staff", routeName: "admin/contact-schedules PATCH" },
);
...
export const DELETE = withCaller(
  ...
  { minRole: "staff", routeName: "admin/contact-schedules DELETE" },
);
