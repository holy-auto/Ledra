...
import { apiOk, apiForbidden, apiValidationError, apiNotFound, apiInternalError } from "@/lib/api/response";
...
export const GET = withCaller(
  ...
  { routeName: "admin/platform/shop-orders GET" },
);
...
export const PUT = withCaller(
  ...
  { routeName: "admin/platform/shop-orders PUT" },
);
