...
export const GET = withCaller(
  ...
  { permission: "register_sessions:view", routeName: "admin/register-sessions GET" },
);
...
export const POST = withCaller(
  ...
  { permission: "register_sessions:operate", routeName: "admin/register-sessions POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "register_sessions:operate", routeName: "admin/register-sessions PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "register_sessions:manage", routeName: "admin/register-sessions DELETE" },
);
