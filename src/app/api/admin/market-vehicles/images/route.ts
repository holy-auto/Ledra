...
export const GET = withCaller(
  ...
  { routeName: "admin/market-vehicles/images GET" },
);
...
export const POST = withCaller(
  ...
  { permission: "market:edit", routeName: "admin/market-vehicles/images POST" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "market:edit", routeName: "admin/market-vehicles/images DELETE" },
);
