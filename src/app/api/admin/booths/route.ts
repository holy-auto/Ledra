...
export const POST = withCaller(
  ...
  { permission: "reservations:edit", routeName: "booth create" },
);
...
export const PUT = withCaller(
  ...
  { permission: "reservations:edit", routeName: "booth update" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "reservations:edit", routeName: "booth delete" },
);
