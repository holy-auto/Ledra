...
export const GET = withCaller<{ id: string }>(
  ...
  { routeName: "admin/inventory/items/[id] GET" },
);
...
export const PUT = withCaller<{ id: string }>(
  ...
  { permission: "menu_items:manage", routeName: "admin/inventory/items/[id] PUT" },
);
...
export const DELETE = withCaller<{ id: string }>(
  ...
  { permission: "menu_items:manage", routeName: "admin/inventory/items/[id] DELETE" },
);
