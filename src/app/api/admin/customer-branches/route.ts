...
export const GET = withCaller(
  ...
  { permission: "customers:view", routeName: "customer-branches GET" },
);
...
export const POST = withCaller(
  ...
  { permission: "customers:edit", routeName: "customer-branches POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "customers:edit", routeName: "customer-branches PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "customers:edit", routeName: "customer-branches DELETE" },
);
