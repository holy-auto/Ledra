...
export const POST = withCaller(
  ...
  { permission: "customers:create", routeName: "customers POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "customers:edit", routeName: "customers PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "customers:delete", routeName: "customers DELETE" },
);
