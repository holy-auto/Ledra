...
export const GET = withCaller(
  async (request, { caller }) => {
    try {
      ...
      const admin = createPlatformScopedAdmin("agent-invoices — platform-wide agent operations (no tenant scope)");
