...
import { apiJson, apiValidationError, apiNotFound, apiInternalError, apiOk } from "@/lib/api/response";
...
export const GET = withCaller(
  ...
  { routeName: "document_templates GET" },
);
...
export const POST = withCaller(
  ...
  { rateLimit: "general", permission: "templates:manage", routeName: "document_templates POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "templates:manage", routeName: "document_templates PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "templates:manage", routeName: "document_templates DELETE" },
);
