...
export const GET = withCaller(
  ...
  { permission: "payments:view", routeName: "admin/payments GET" },
);
...
export const POST = withCaller(
  async (req, { caller, supabase }) => {
    try {
      ...
      const changeAmount =
        input.received_amount != null && input.received_amount > input.amount
          ? input.received_amount - input.amount
          : 0;
  ...
  { rateLimit: "general", permission: "payments:create", routeName: "admin/payments POST" },
);
...
export const PUT = withCaller(
  ...
  { permission: "payments:manage", routeName: "admin/payments PUT" },
);
...
export const DELETE = withCaller(
  ...
  { permission: "payments:manage", routeName: "admin/payments DELETE" },
);
