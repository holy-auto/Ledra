...
export const GET = withCaller(
  async (request, { caller }) => {
    try {
      ...
      const admin = createPlatformScopedAdmin("agent-materials — platform-wide agent operations (no tenant scope)");
...
export const POST = withCaller(
  ...
  { routeName: "agent-materials POST" },
);
