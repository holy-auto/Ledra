...
import { apiJson, apiNotFound, apiValidationError, apiForbidden, apiInternalError } from "@/lib/api/response";
...
export const POST = withCaller<{ id: string }>(
  ...
  { minRole: "staff", routeName: "admin/orders/[id]/inspection-sign POST" },
);
