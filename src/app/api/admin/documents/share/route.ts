...
import { apiOk, apiValidationError, apiInternalError, apiNotFound } from "@/lib/api/response";
...
export const GET = withCaller(
  ...
  { routeName: "document_share_history" },
);
...
export const POST = withCaller(
  ...
  { minRole: "staff", routeName: "document_share" },
);
