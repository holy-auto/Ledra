  ...
  return (
    ...
    >
      ...
      <div className="px-10 py-2.5 flex items-center justify-between border-t border-white/[0.06] shrink-0">
        <span className="text-white text-[11px] tracking-wide">Ledra — Confidential · 2026年5月</span>
...
function Chip({
  ...
  color?: "amber" | "orange" | "green" | "rose" | "none";
}) {
  const cls =
    color === "amber"
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return <p className="text-xs font-semibold uppercase tracking-widest text-amber-400">{children}</p>;
}

function H2({ children }: { children: React.ReactNode }) {
  return <h2 className="text-2xl font-extrabold text-white leading-snug">{children}</h2>;
}
  ...
  <S n={1}>
    <div className="flex flex-col items-center justify-center flex-1 text-center px-10 gap-5">
      <div className="flex gap-2 flex-wrap justify-center">
        ...
        <Chip color="none">2026年5月</Chip>
      </div>
      <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight text-white">
        <span className="bg-gradient-to-r from-amber-300 to-orange-300 bg-clip-text text-transparent">Ledra</span>
      </h1>
      <p className="text-xl text-white max-w-2xl leading-relaxed font-semibold">職人の技術を、次へつなぐ。</p>
      <p className="text-sm text-white max-w-xl leading-relaxed">
        自動車整備・コーティング・PPF・板金塗装店向け
        <br />
        マルチテナント SaaS / WEB 施工証明書ネットワーク
      </p>
      <div className="mt-3 flex gap-6 text-xs text-white">
  ...
  <S n={2}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <H2>「次へつなぐ」3つの軸</H2>
        <p className="text-sm text-white mt-1">職人の手仕事を、デジタル資産として 3 つの「次」へ承継する。</p>
      </div>
  ...
  <S n={3}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <H2>真面目な施工店ほど、書類で消耗する</H2>
        <p className="text-sm text-white mt-1">
          自動車後付け施工市場は「記録の分断」「改ざん耐性の欠如」「流通の断絶」の三重苦。
        </p>
      </div>
      <div className="grid grid-cols-3 gap-4 flex-1">
        {[
          {
            n: "①",
            tag: "記録の分断",
            title: "紙・LINE・Excel に散逸",
            body: "施工写真は LINE、見積は Excel、車検証はファイル棚。1件あたり 30〜60 分の二重入力。複数年の履歴を辿るのは実質不可能。",
          },
          {
            n: "②",
            tag: "改ざん耐性ゼロ",
            title: "「やった」を証明できない",
            body: "保証期間中のトラブル・保険会社からの確認・中古車買取での「過去施工歴」など、第三者検証の手段が現場に存在しない。",
          },
          {
            n: "③",
            tag: "流通断絶",
            title: "施工価値が次の市場へ流れない",
            body: "数十万円の高額コーティング・PPFが、3年後の中古車査定では加点ゼロ。職人の技術が経済的価値として承継されない。",
          },
        ].map((item) => (
          <div key={item.n} className="rounded-xl border border-rose-500/15 bg-rose-500/[0.04] p-5 flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <span className="text-3xl font-extrabold text-rose-300">{item.n}</span>
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-4">
          <div className="flex items-center justify-between gap-4">
            <span className="text-sm font-bold text-amber-200">Ledra プラットフォーム</span>
            <span className="text-[11px] text-white">Multi-tenant SaaS + Public Verification Layer</span>
          </div>
        </div>
        <div className="grid grid-cols-4 gap-3 flex-1">
          {[
            ...
            },
            {
              ...
              tone: "from-amber-500/12 to-orange-500/8",
            },
            {
              role: "代理店",
              port: "Agent Portal",
              body: "施工店紹介・コミッション管理・キャンペーン配信。FC 的な拡大を支える 7 機能。",
              tone: "from-amber-500/10 to-orange-500/6",
            },
            {
              role: "損保 / 中古車",
              port: "Insurer Portal",
            ...
            <div
              key={p.role}
              className={`rounded-xl border border-white/[0.08] bg-gradient-to-br ${p.tone} p-4 flex flex-col gap-2`}
            >
              <Chip color="orange">{p.role}</Chip>
              <div className="text-xs font-bold text-white">{p.port}</div>
              <p className="text-[11px] text-white leading-relaxed">{p.body}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  <S n={5}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <p className="text-sm text-white mt-1">4 つの外部要因が「施工台帳」需要を同時に立ち上げている。</p>
      </div>
      <div className="grid grid-cols-2 gap-4 flex-1">
        {[
          ...
          <div key={item.tag} className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-5 flex flex-col gap-2">
            <Chip color="amber">{item.tag}</Chip>
  ...
  <S n={6}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      ...
      <div className="flex gap-5 flex-1">
        <div className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.03] p-5 flex flex-col gap-3">
          <div className="text-xs font-semibold uppercase tracking-widest text-amber-400">実装規模</div>
          <div className="space-y-2">
            {[
              ...
              >
                <span className="text-xs text-white">{row.k}</span>
                <span className="text-xs font-bold text-amber-300">{row.v}</span>
              </div>
            ))}
          </div>
        </div>
        <div className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.03] p-5 flex flex-col gap-3">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={row.title}>
                <div className="text-xs font-bold text-white">{row.title}</div>
                <p className="text-[11px] text-white leading-relaxed mt-0.5">{row.body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {[
          {
            ...
            color: "from-amber-500/40 to-amber-700/30",
          },
          {
            n: 2,
            layer: "技術レイヤー",
          ...
          },
          {
            ...
            color: "from-orange-600/40 to-amber-700/30",
          },
        ].map((step) => (
          <div key={step.n} className="flex items-start gap-4">
            <div
              className={`h-10 w-10 shrink-0 rounded-full bg-gradient-to-br ${step.color} flex items-center justify-center text-sm font-bold text-white shadow-[0_0_16px_rgba(245,158,11,0.3)]`}
            >
              {step.n}
            </div>
            <div className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.03] px-4 py-3">
              <div className="flex items-center gap-2 mb-1">
                <Chip color="orange">{step.layer}</Chip>
              </div>
              <div className="text-sm font-bold text-white">{step.title}</div>
              <p className="text-[11px] text-white leading-relaxed mt-1">{step.body}</p>
            </div>
          </div>
        ))}
      </div>
  ...
  <S n={8}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <p className="text-sm text-white mt-1">代表自身が、本プロダクトのターゲット顧客として 10 年を過ごしてきた。</p>
      </div>
      <div className="flex-1 flex flex-col gap-2 justify-center">
        {[
          ...
          },
          {
            year: "2016",
            role: "新規事業 / 接客",
            place: "カフェ「Hungry」（茨城・つくば市）新規立ち上げ・大江戸温泉物語・快活クラブ",
          ...
          <div
            key={row.year}
            className="flex items-center gap-4 rounded-lg border border-white/[0.06] bg-white/[0.02] px-4 py-2"
          >
            <div className="text-amber-300 font-mono text-xs font-bold w-16 shrink-0">{row.year}</div>
            <div className="text-sm font-bold text-white w-40 shrink-0">{row.role}</div>
            <div className="text-[11px] text-white flex-1 min-w-0 truncate">{row.place}</div>
  ...
  <S n={9}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <H2>4 年 × 2,800 台のドッグフード検証済み</H2>
        <p className="text-sm text-white mt-1">
          SaaS 単体の数字は黎明期だが、創業者が運営する施工店での運用検証は累計 4 年 2,800 台に及ぶ。
        </p>
      </div>
      <div className="grid grid-cols-2 gap-5 flex-1">
        <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.04] p-5 flex flex-col gap-3">
          ...
          <div className="space-y-2">
            {[
              ...
              >
                <span className="text-xs text-white">{row.k}</span>
                <span className="text-sm font-bold text-amber-300">{row.v}</span>
              </div>
            ))}
          </div>
        </div>
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-5 flex flex-col gap-3">
          ...
          <div className="space-y-2">
            {[
              ...
              >
                <span className="text-xs text-white">{row.k}</span>
                <span className="text-sm font-bold text-emerald-300">{row.v}</span>
              </div>
            ))}
          </div>
        </div>
      </div>
      <p className="text-[11px] text-white leading-relaxed text-center -mt-1">
        プロダクトは「いま作るもの」ではなく「すでに 4 年運用検証されたものを SaaS 化したもの」である。
      </p>
    </div>
  </S>
);
    ...
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div
            key={m.label}
            className="rounded-xl border border-amber-500/20 bg-gradient-to-br from-amber-500/[0.08] to-orange-500/[0.04] p-5 flex flex-col gap-2"
          >
            <div className="text-xs text-white">{m.label}</div>
            <div className="text-3xl font-extrabold text-amber-300">{m.value}</div>
            <div className="text-[11px] text-white">{m.sub}</div>
            <div className="text-[10px] text-white border-t border-white/[0.06] pt-2">出典: {m.source}</div>
          </div>
        ))}
      </div>
      <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4 flex-1 flex flex-col gap-3 justify-center">
        <div className="grid grid-cols-3 gap-4 text-center">
          {[
            ...
            <div key={m.k}>
              ...
              <div className="text-2xl font-extrabold text-white mt-1">{m.v}</div>
              <div className="text-[10px] text-white leading-tight mt-1">{m.sub}</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] overflow-hidden">
          <div className="grid grid-cols-5 text-xs font-semibold text-amber-400 bg-white/[0.04] px-4 py-2.5 border-b border-white/[0.06] uppercase tracking-wide">
            <span>プラン</span>
            <span>月額</span>
            <span>証明書</span>
            <span>ユーザー</span>
          ...
          {[
            ...
            <div
              key={row.plan}
              className="grid grid-cols-5 px-4 py-2.5 text-xs border-b border-white/[0.05] last:border-0"
            >
              <span className="text-white font-semibold">{row.plan}</span>
              <span className="text-amber-300 font-bold">{row.price}</span>
              <span className="text-white">{row.cert}</span>
              <span className="text-white">{row.user}</span>
              <span className="text-white text-[11px]">{row.feat}</span>
            </div>
          ))}
        </div>
        <div className="grid grid-cols-3 gap-3 flex-1">
          {[
            ...
            <div key={m.tag} className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4 flex flex-col gap-2">
              <Chip color="amber">{m.tag}</Chip>
              <div className="text-sm font-bold text-white">{m.title}</div>
              <p className="text-[11px] text-white leading-relaxed">{m.body}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  <S n={12}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      <div>
        ...
        <p className="text-sm text-white mt-1">現在この交差点に立つプレイヤーは国内に存在しない。</p>
      </div>
      <div className="flex-1 flex gap-5">
        <div className="flex-1 rounded-xl border border-white/[0.08] bg-white/[0.03] p-5 relative">
          <div className="absolute top-3 left-3 text-[10px] text-white">業界横断ネットワーク</div>
          <div className="absolute bottom-3 left-3 text-[10px] text-white">店舗単体運用</div>
          <div className="absolute top-1/2 left-3 text-[10px] text-white -rotate-90 origin-left">↑ 流通レイヤー</div>
          <div className="absolute bottom-3 right-3 text-[10px] text-white">改ざん検証 / 公開検証</div>
          <div className="absolute bottom-3 left-1/2 text-[10px] text-white -translate-x-1/2">→ 検証可能性</div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full">
            <div className="absolute top-[20%] left-[15%] text-[11px] px-2 py-1 rounded bg-white/10 text-white">
              整備工場 SaaS（broline 等）
            </div>
            <div className="absolute top-[55%] left-[10%] text-[11px] px-2 py-1 rounded bg-white/10 text-white">
              紙台帳 / Excel
            </div>
            <div className="absolute top-[70%] left-[35%] text-[11px] px-2 py-1 rounded bg-white/10 text-white">
              自前 PDF 証明書
            </div>
            <div className="absolute top-[25%] left-[55%] text-[11px] px-2 py-1 rounded bg-white/10 text-white">
              中古車 PF / 損保査定系
            </div>
            <div className="absolute top-[15%] left-[68%] text-[12px] px-3 py-2 rounded-lg bg-gradient-to-br from-amber-500 to-orange-500 text-white font-bold shadow-[0_0_20px_rgba(245,158,11,0.5)]">
              Ledra
            </div>
          </div>
        </div>
        <div className="w-72 flex flex-col gap-3">
          <div className="rounded-xl border border-amber-500/20 bg-amber-500/[0.06] p-4">
            <div className="text-xs font-bold text-amber-300 mb-1">Ledra のポジション</div>
            <p className="text-[11px] text-white leading-relaxed">
              業務 SaaS（縦軸：店舗運用） と 証明書ネットワーク（横軸：検証・流通）の両方を統合した唯一のプレイヤー。
            </p>
          </div>
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4">
            <div className="text-xs font-bold text-white mb-1">後発参入の障壁</div>
            <p className="text-[11px] text-white leading-relaxed">
        ...
        {[
          ...
          <div
            ...
            className={`rounded-xl border ${
              i === 1 ? "border-amber-500/30 bg-amber-500/[0.06]" : "border-white/[0.08] bg-white/[0.03]"
            } p-5 flex flex-col gap-3`}
          >
            <div className="flex items-center justify-between">
              <Chip color={i === 1 ? "orange" : "amber"}>{m.term}</Chip>
              <span className="text-[10px] text-white">{i === 1 ? "本ラウンド目標" : ""}</span>
            </div>
            <div className="text-sm font-bold text-white leading-snug">{m.kpi}</div>
            <ul className="space-y-1.5 mt-1">
              {m.items.map((it) => (
                <li key={it} className="text-[11px] text-white leading-relaxed flex gap-2">
  ...
  <S n={14}>
    <div className="flex flex-col flex-1 px-10 pt-8 pb-2 gap-5">
      ...
      <div className="flex-1 flex flex-col gap-4">
        <div className="rounded-xl border border-amber-500/25 bg-amber-500/[0.05] p-5 flex gap-5">
          <div className="h-20 w-20 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-2xl font-extrabold text-white shadow-[0_0_24px_rgba(245,158,11,0.4)] shrink-0">
            堀越
          </div>
          <div className="flex-1">
            <div className="flex items-center gap-3 flex-wrap">
              <span className="text-base font-bold text-white">堀越 友輔（30）</span>
              <Chip color="orange">代表取締役 / Founder</Chip>
              <span className="text-[11px] text-white">1995/06/19 生</span>
            </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={r.role} className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-4 flex flex-col gap-2">
              <div className="text-xs font-bold text-white">{r.role}</div>
              <Chip color="amber">{r.status}</Chip>
              <p className="text-[11px] text-white leading-relaxed">{r.desc}</p>
            </div>
          ))}
        </div>
