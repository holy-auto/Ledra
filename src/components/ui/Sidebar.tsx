...
const NAV_GROUPS: NavGroup[] = [
        ...
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5M9 12.75h.008v.008H9v-.008Zm0 2.25h.008v.008H9V15Zm0 2.25h.008v.008H9v-.008Zm3-4.5h.008v.008H12v-.008Zm0 2.25h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008Zm3-4.5h.008v.008H15v-.008Zm0 2.25h.008v.008H15V15Z"
            />
          </svg>
        ),
      },
        ...
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v12a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18V6ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v7.5A2.25 2.25 0 0 1 18 15.75h-2.25a2.25 2.25 0 0 1-2.25-2.25V6Z"
            />
          </svg>
        ),
      },
        ...
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-3 1.5 1.5 3-3"
            />
          </svg>
        ),
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/notification-broadcasts",
        label: "一斉配信",
        requiredPermission: "customers:view",
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/analytics/churn-risk",
        label: "離反予測",
        requiredPermission: "management:view",
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        href: "/admin/analytics/technician-performance",
        label: "技術者分析",
        requiredPermission: "management:view",
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        icon: (
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5M8.25 12h.008v.008H8.25V12Zm0 3h.008v.008H8.25V15Zm3.75-3h.008v.008H12V12Zm0 3h.008v.008H12V15Zm3.75-3h.008v.008h-.008V12Zm0 3h.008v.008h-.008V15Z"
            />
          </svg>
        ),
      },
