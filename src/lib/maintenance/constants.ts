...
export const FINDING_CATEGORY_OPTIONS = Object.entries(FINDING_CATEGORY_LABELS).map(
...
export const FINDING_SEVERITY_OPTIONS = Object.entries(FINDING_SEVERITY_LABELS).map(
  ([value, label]) => ({ value, label })
);
