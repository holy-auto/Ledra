...
export const siteConfig = {
  ...
  siteTagline: "自動車整備・コーティング店のAI業務管理SaaS",
  siteDescription:
    "Ledra（レドラ）は、自動車整備・鈑金塗装・コーティング・PPF施工店向けのAI搭載クラウド業務管理SaaS。" +
    "予約・作業管理から、改ざん検知付きの施工証明書発行、請求・帳票、顧客管理、保険会社との案件連携までを一本化します。",

  /**
   * SEO / AI検索(GEO)向けキーワード。Google はほぼ無視するが、LLM クローラーや
   * 一部の検索エンジンは meta keywords / JSON-LD の keywords を参照する。
   * 「施工証明書」だけでなく、実際の業務領域（整備・鈑金・コーティング・PPF・
   * 予約・顧客管理・保険連携）を網羅する。
   */
  keywords: [
    "自動車整備 SaaS",
   ...
   * 事実ベースで拾えるようにする（出典: README.md / LEDRA_CURRENT.md）。
   */
  featureList: [
    "予約・作業スケジュール管理",
