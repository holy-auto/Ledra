...
> 2026-08-26 追記6: **Stripe で出せない QR 決済（d払い / 楽天ペイ / au PAY /
...
> 2026-08-26 追記5: **店頭 QR 会計で使える決済手段を全部載せた。** カードに
...
> 2026-08-26 追記4: **PayPay の利用申請を Connect オンボーディングと同時に
...
> 2026-08-26 追記3: **店頭 QR 会計に PayPay を出せるようにした。** これまで
