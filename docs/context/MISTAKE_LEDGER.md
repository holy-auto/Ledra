...
- 追記1 の数え直しで **438 箇所**（台帳の外 227 / 台帳本文 211）と書いた。
  ...
  （この 440 はベース `af9b3f5b` 時点の数。その後 `main` が進み、最終的なベース
  `acf89574` では 446 箇所になった。**ベースが動けば母数も動く**ので、
  数字にはベースの SHA を添える。）
