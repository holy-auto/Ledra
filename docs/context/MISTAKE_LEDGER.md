...
## M-002 正規表現がロール名の部分一致を起こしていた（2026-09-05）
...
## M-003 検出器のガード語彙が不完全なのに、出力を「認可が無い」と読んだ（2026-09-05）
...
## M-004 コードの形から分類し、中身を読んでいなかった（2026-09-05）
...
## M-005 同じ操作に2経路あるのに1本だけ塞いだ（2026-09-05）
...
## M-006 検出器を広げたら、業務ロジックを認可と誤認した（2026-09-05）
