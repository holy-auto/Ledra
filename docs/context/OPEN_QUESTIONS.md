...
| `20260917000400` = `workshop_capability_profiles`（5 statements） | main にファイルが無い。どの open PR にも該当ファイルが無い【要確認】 |
| `20260917100000` = `ft_tenant_rls_and_storage`（19 statements） | **PR #1093 の5本目**。名前のとおり `ft_*` の RLS と Storage |
