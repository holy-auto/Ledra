...
## 工数データを d-Happy（sfh.honda.co.jp）から自動収集してよいか（2026-09-23）
...
案: (1) 人がサイトで検索し、表の「Copy」ボタンでコピーした内容を Ledra に貼り付けて一括登録する
（コピー形式のサンプル待ち）。(2) Honda Access / 販売会社に自動取得の可否・データ提供を問い合わせる。
