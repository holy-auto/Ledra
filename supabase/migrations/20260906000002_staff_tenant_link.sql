-- 【2026-09-04 / 09-05 / 09-06 と3回改名】元のファイル名は 20260903000000 だった。base（main）と本番の適用済み最新は 20260905142740（2026-09-06 時点）で、それより古いバージョンの未適用ファイルがあると
...
--
-- 背景:
--   外注職人が施工した記録は元請けのテナントに元請け名義で残る（20260906000000 の判断）。
...
-- 索引は CONCURRENTLY のため別ファイル (20260906000003)。
