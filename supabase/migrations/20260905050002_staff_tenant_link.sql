-- 【2026-09-04 改名 → 2026-09-05 再改名】元のファイル名は 20260903000000 だった。base（main）の最新は 20260905040000、本番の適用済み最新は
...
--
-- 背景:
--   外注職人が施工した記録は元請けのテナントに元請け名義で残る（20260905050000 の判断）。
...
-- 索引は CONCURRENTLY のため別ファイル (20260905050003)。
