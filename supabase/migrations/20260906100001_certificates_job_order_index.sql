-- 【2026-09-04 / 09-05 / 09-06 ×2 と4回改名】元のファイル名は 20260901000002 だった。base（main）と本番の適用済み最新は 20260906094735（2026-09-06 時点。#966 が
-- apply_migration で本番へ直接当てた版）で、それより古いバージョンの未適用ファイルがあると
