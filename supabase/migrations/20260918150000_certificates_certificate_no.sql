...
-- 詳細画面は依然として動いていない。
--
-- 版番号の注記: 起票時は 20260918000000 だったが、本番の台帳の最大が 20260918142610
-- だったため改名した。リポジトリの migrations.production-ledger は max: 20260906100003
-- で止まっており、lint:migrations はそれを見るので**この out-of-order を検出できない**
-- （OPEN_QUESTIONS「production-ledger を誰がいつ更新するか」）。本番へ直接聞いて気づいた。
--
